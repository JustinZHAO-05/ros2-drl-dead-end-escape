...
def launch_setup(context):
    ...
    bridge = Node(
        ...
        arguments=[
                ...
                # # ==== ROS2→IGN  / IGN→ROS2 的 service 映射 ====
                #  '/world/all_training/control@ros_gz_interfaces/srv/ControlWorld',#@ignition.msgs.Entity@ignition.msgs.Boolean',
                # # 标记上面是 services
                # '--services',     
                # '/world/all_training/physics/contacts@ros_gz_interfaces/msg/Contacts@ignition.msgs.Contacts',
                # '/world/all_training/set_pose@srv@ros_gz_interfaces/srv/SetEntityPose@ignition.msgs.Pose',           
